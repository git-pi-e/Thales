...
Wrap the button in a container that uses the [font-size utility classes]({{ site.baseurl }}{% link docs/Thales/layout-typo.md %}) to scale buttons:
...
Use the [margin utility classes]({{ site.baseurl }}{% link docs/Thales/layout-typo.md %}#spacing) to add spacing between two buttons in the same block.
